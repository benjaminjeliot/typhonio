...
!  TIO_CHECK( TIO_Create_Vargroup_f(file_id, state_id, "VarGroup1", vargroup_id1) )
  ierr = TIO_Create_Vargroup_f(file_id, state_id, "VarGroup1", vargroup_id1)
  call tio_check_error(ierr, __LINE__)
!  TIO_CHECK( TIO_Create_Vargroup_f(file_id, state_id, "VarGroup2", vargroup_id2) )
  ierr = TIO_Create_Vargroup_f(file_id, state_id, "VarGroup2", vargroup_id2)
  call tio_check_error(ierr, __LINE__)
!  TIO_CHECK( TIO_Create_Vargroup_f(file_id, state_id, "VarGroup3", vargroup_id3) )
  ierr = TIO_Create_Vargroup_f(file_id, state_id, "VarGroup3", vargroup_id3)
  call tio_check_error(ierr, __LINE__)
